            ...
            [
                ...
                },
                {
                    ...
                    "parameter": {
                        ...
                        "CONV": {"EL": 0.0115},
                        "EFF": 0.55897149,
                        "EF_E": {"CO2-C": 1000.0, "EL": 30.0, "NG-G": 201.0},
                        "EF_M": {"CO2-C": 1000.0, "EL": 30.0, "NG-G": 201.0},
                        "FLH": 7000,
                        "LIFETIME": 25.0,
                        "OPEX-F": 24.8292,
                ...
                {
                    "costs": {"OPEX": 0.01222087},
                    "flows": {"main_flow_out": 0.08261781},
                    "is_in_import_segment": True,
                    "parameter": {
                        "EFF": 0.95,
                        "EF_E": {"CO2-C": 1000.0},
                ...
                },
                {
                    ...
                    "is_in_import_segment": True,
                    "parameter": {"SPECCOST": {"EL": 0.10554551}},
                    "process_code": "EL",
                    "process_step": "MARKET:IMPORT:EL",
                },
            ],
            ...
            [
                ...
                },
                {
                    ...
                    "emissions": {
                        "emission": {
                            ...
                            "co2_indirect_scope2": 0.04242812,
                        },
                        "mass": {
                            "co2_bound_in_product": 592.22579704,
                            "co2_bound_in_product_per_output": 201.00000001,
                ...
                },
                {
                    ...
                    "parameter": {
                        ...
                        "EFF": 1.01010101,
                        "EF_E": {"EL": 30.0, "NG-G": 201.0},
                        "EF_M": {"EL": 30.0, "NG-G": 201.0},
                        "FLH": 7000,
                        "LIFETIME": 20.0,
                        "OPEX-F": 86.39181546,
                        "OPEX-O": 0.18420559,
                ...
                {
                    "costs": {"FLOW": 0.00014927},
                    "flows": {"main_flow_out": 0.00141427},
                    "is_in_import_segment": True,
                    "parameter": {"SPECCOST": {"EL": 0.10554551}},
                    "process_code": "EL",
                    "process_step": "MARKET:IMPORT:EL",
                ...
                {
                    "costs": {"FLOW": 0.04982698},
                    "flows": {"main_flow_out": 0.47209},
                    "is_in_import_segment": True,
                    "parameter": {"SPECCOST": {"EL": 0.10554551}},
                    "process_code": "EL",
                    "process_step": "MARKET:IMPORT:EL",
    ...
    for secproc_co2 in SecProcCO2Values:
        ...
        for demand_supply in ["demand", "supply"]:
            ...
            for mass_emission, df_e in [
                ...
                assert result._internal_process_data
    ...
    expected_results = [
        {
            "co2_bound_in_product": [
                ...
                {"process": "HEATPUMP#B"},
                {"process": "Bound in product", "value": 69.02619241},
            ],
